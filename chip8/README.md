...
* `6xnn` - положить в регистр `vx` значение `nn`;
* `Annn` - положить в регистр `I` значение `nnn`;
...
* `1nnn` - установить счётчик команд равным `nnn` (jump);
* `2nnn` - положить адрес следующей инструкции на стек вызовов и установить счётчик команд равным `nnn` (call);
