...
Перед тем, как читать дальше, попробуйте сами сыграть в эту игру, вызвав `make play_keyboard`.
Вы играете за синий квадратик, управление стрелками.
...
Вам нужно дописать код в файл `src/strategy.rs`. Протокол взаимодействия со стратегией следующие:
...
Раннер игры написан на Python 3, поэтому для запуска стратегии вам понадобятся:
